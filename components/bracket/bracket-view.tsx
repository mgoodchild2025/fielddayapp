...
//   court/time header (~24px) + 2 team rows (~72px) + score row + "Edit Match"
//   link (~70px). Generous headroom keeps the Edit link clear of the card below
//   once a score is entered.
const MATCH_HEIGHT = 184
const MATCH_GAP = 40
const ROUND_WIDTH = 264
