                  ...
                  return (
                    <tr key={game.id} className="border-b border-gray-200">
                      ...
                      <td className="py-2 pr-3 font-medium">
                        ...
                        {opponent}
                        {game.isExhibition && <ExhibitionMark />}
                      </td>
                    </tr>
                  )
                }
                ...
                return (
                  <tr key={game.id} className="border-b border-gray-200">
                    ...
                    <td className="py-2 px-3">
                      ...
                      {game.isExhibition && <div className="text-center"><ExhibitionMark /></div>}
                    </td>
...
/**
 * Print-safe exhibition marker: plain grey text rather than the coloured pill
 * the screens use, so it stays legible on a black-and-white printer.
 */
function ExhibitionMark() {
  return (
