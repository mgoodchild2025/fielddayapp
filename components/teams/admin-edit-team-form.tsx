    ...
    <div className="mt-3 pt-3 border-t space-y-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <label className="w-7 h-7 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center cursor-pointer hover:border-gray-400 transition-colors overflow-hidden" title="Custom colour">
            <input
              type="color"
              value={color}
      ...
      <div>
        ...
        {logoPreview ? (
          <div className="flex items-center gap-3 mb-2">
            ...
            <img src={logoPreview} alt="Logo preview" className="w-16 h-16 rounded-lg object-contain border bg-gray-50" />
            <button
              type="button"
        ...
        <input
          ...
          className="text-xs text-gray-600 file:mr-3 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:font-medium file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
        />
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={pending}
          className="px-4 py-1.5 rounded-md text-xs font-semibold border hover:bg-gray-50"
        >
          Cancel
        </button>
      </div>
