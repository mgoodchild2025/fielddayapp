...
import { getShopPnl } from '@/actions/finances'
...
export default async function FinancesPage() {
  ...
  const shop = await getShopPnl(org.id)
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Track profit across your shop and events. Set a unit cost on items to see margins.
        </p>
      </div>
